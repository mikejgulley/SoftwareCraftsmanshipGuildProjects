...
<html lang="en">
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <div class="nav navbar-nav navbar-right">
                        <!--<button type="button" class="btn btn-primary" id="signup-button" onclick="signup()">Sign Up / User Login</button>-->

                        <!-- Sign Up/Log In new code here: -->
        ...
        <div class="container">
            <div class="col-md-12">
                <h3 class="admin-task-title">Edit Blog Post:</h3>
                <form method="POST" action="/editPost">
                    <div class="form-group">
                        <label for="postTitle">Title</label>
                        <input type="text" class="form-control" id="postTitle" value="${postTitle}" placeholder="Post Title">
                    </div>
                    <div class="form-group">
                        <label for="from">From <span class="start-finish-date-text">(0 = no starting date)</span></label>
                        <input type="text" class="form-control" id="from" name="from" value="${postStartDate}" placeholder="Starting Date">
                    </div>
                    <div class="form-group">
                        <label for="to">to <span class="start-finish-date-text">(0 = no expiration date)</span></label>
                        <input type="text" class="form-control" id="to" name="to" value="${postExpirationDate}" placeholder="Expiration Date">
                    </div>
                    <div class="form-group">
                        <textarea name="content" style="width:100%">${postBody}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="tags">Tags <span class="start-finish-date-text">(separate each tag with a comma)</span></label>
                        <input type="text" class="form-control" id="tags" name="tags" placeholder="Tags" value="${postTags}">
                    </div>
                    <p hidden id="postId">${postId}</p>
                    <p hidden id="postStartDate">${postStartDate}</p>
                    <p hidden id="postExpirationDate">${postExpirationDate}</p>
                    <button class="btn btn-primary" type="submit" id="edit-post-button">Update Post</button>
                </form>
