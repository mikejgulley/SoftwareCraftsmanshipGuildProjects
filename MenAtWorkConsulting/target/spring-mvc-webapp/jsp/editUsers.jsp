...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <div class="col-md-offset-3 col-md-6">
                <h3 class="admin-task-title">Edit User Privileges:</h3>
                <div class="item">
                    <form action="${pageContext.request.contextPath}/admin/editAuthorities" method="POST">
                            <div class="form-group"
                                    <label for="username-dropdown">User:</label>
                                    <select class="form-control" id="username-dropdown" name="username">
                                            <!--<option>1</option>-->
                                    </select>
                            </div>
                            <div class="form-group"
                                    <label for="authority-dropdown">Privilege:</label>
                                    <select class="form-control" id="authority-dropdown" name="authority">
                                            <option>User</option>
                                            <option>Guest Poster</option>
                                            <option>Admin</option>
                                            <option>Banhammer (Delete User)</option>
                                    </select>
                            </div>
	...
	<script src="${pageContext.request.contextPath}/js/editAuthorities.js"></script>
</body>
</html>