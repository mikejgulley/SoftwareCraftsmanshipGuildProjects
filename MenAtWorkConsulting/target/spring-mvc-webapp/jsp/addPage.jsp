...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <div class="col-md-12">
                <h3 class="admin-task-title">Add Web Page:</h3>
                <form method="post" action="/addPost">
                    <div class="form-group">
                        <label for="postTitle">Title</label>
                        <input type="text" class="form-control" id="pageTitle" placeholder="Title" autofocus="true">
                    </div>
                    <div class="form-group">
                        <textarea name="content" style="width:100%"></textarea>
                    </div>
                    <button class="btn btn-primary" type="submit" id="add-page-button">Add Page</button>
                </form>
            </div>
        </div>
        <div class="container">
...
<!--                <div class="col-md-6">
        ...
        <script src="${pageContext.request.contextPath}/js/addPage.js"></script>
        <script src="${pageContext.request.contextPath}/js/navbar.js"></script>
        <!--<script src="${pageContext.request.contextPath}/js/jquery.textareaCounter.plugin.js"></script>-->
    </body>
</html>
