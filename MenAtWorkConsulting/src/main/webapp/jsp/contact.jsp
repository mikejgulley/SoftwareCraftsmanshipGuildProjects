...
<html lang="en">
    <head>
        ...
        <title>Contact Us | Men at Work Consulting</title>
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav" id="navbar">
                        ...
                        <li class="active"><a href="${pageContext.request.contextPath}/contact">Contact <span class="sr-only">(current)</span></a></li>
                    </ul>
        ...
        <div class="container">
            <div class="col-md-offset-3 col-md-6">
                <h3 class="admin-task-title">We would love to hear from you!</h3>
                <form method="POST" action="${pageContext.request.contextPath}/sendMessage" id="commentForm">
                    <div id="validationErrors" style="color: red"></div>
                    <div class="form-group">
                        <label for="firstName">First Name:</label>
                        <input type="text" class="form-control" id="firstName" name="firstName" placeholder="First Name" autofocus="true" minlength="2" maxlength="30" required>
                    </div>
                    <div class="form-group">
                        <label for="lastName">Last Name:</label>
                        <input type="text" class="form-control" id="lastName" name="lastName" placeholder="Last Name" minlength="2" maxlength="50" required>
                    </div>
                    <div class="form-group">
                        <label for="email">Email Address:</label>
                        <input type="email" class="form-control" id="email" name="email" placeholder="Email Address" minlength="2" maxlength="50" required>
                    </div>
                    <div class="form-group">
                        <label for="message">Message:</label>
                        <textarea name="message" class="form-control" id="message" name="message" placeholder="Message" rows="10" style="max-width: 100%;" minlength="2" maxlength="1000" required></textarea>
                    </div>
                    <div class="form-group">
                        <%
                    ...
                    <button class="btn btn-primary" type="submit" id="contact-button">Contact Us</button>
                </form>
            </div>
        </div>
        <div class="container">
