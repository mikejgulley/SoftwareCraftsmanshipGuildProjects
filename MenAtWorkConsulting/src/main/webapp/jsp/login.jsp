    ...
    <body>
        ...
        <div class="container">
            <div class="col-md-offset-3 col-md-6">
                <h3 class="admin-task-title">Sign in to the Blog</h3>
                ...
                <form method="post" class="signin" action="j_spring_security_check">
                    <div class="form-group">
                        ...
                        <input id="username_or_email" name="j_username" type="text" class="form-control" autofocus="true" required>
                    </div>
                    <div class="form-group">
                    ...
                    <button name="commit" type="submit" value="Sign In" class="btn btn-primary">Sign In</button>
                </form>
            </div>
        </div>
        <div class="container">
