...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <div class="col-md-12">
                <h3 class="admin-task-title">Edit Blog Page:</h3>
                <form method="POST" action="/MenAtWorkConsulting/editPage">
                    <div class="form-group">
                        <label for="pageTitle">Title</label>
                        <input type="text" class="form-control" id="pageTitle" value="${pageTitle}" placeholder="Page Title">
                    </div>
                    <div class="form-group">
                        <textarea name="content" style="width:100%">${pageBody}</textarea>
                    </div>
                    <p hidden id="pageId">${pageId}</p>
                    <button class="btn btn-primary" type="submit" id="edit-page-button">Update Page</button>
                </form>
