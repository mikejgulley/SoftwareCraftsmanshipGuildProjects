...
<!--        audio 
        <audio autoplay="autoplay" controls="controls">
            <source src="${pageContext.request.contextPath}/audio/Nyan_cat.ogg" type="audio/ogg">
        ...
        <div class="container">
            ...
            <div class="col-md-3" id="date-panel">
                <div class="panel panel-default">
                    <h3 class="panel-heading">
                        <sec:authorize access="isAuthenticated()">
                            Hello, <div id="active-user"><sec:authentication property="principal.username" /></div>!
                        </sec:authorize>
                        <sec:authorize access="!isAuthenticated()">
                            Please log in.
                        </sec:authorize>
                    ...
                    <div class="panel-body">
                        <form method="post" action="${pageContext.request.contextPath}/post/daterange">
                            ...
                            <button class="btn btn-primary" type="button" id="date-range-button">Sort Posts</button>
                        </form>
                    </div>
                </div>
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <button type="button" id="bangers-button" class="btn btn-sm">B</button>
                        <button type="button" id="rancho-button" class="btn btn-sm">R</button>
                        <button type="button" id="default-button" class="btn btn-sm">D</button>
                    </div>
    ...
    <%@include file="addCommentModalFragment.jsp" %>
    ...
    <sec:authorize access="!isAuthenticated()">
        <script src="${pageContext.request.contextPath}/js/anonHome.js"></script>
    </sec:authorize>
